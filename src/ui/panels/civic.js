...
.cb-board { position: fixed; inset: 2.4vh 2.2vw; z-index: 41; display: flex; flex-direction: column;
    ...
    VIEWS_DEF('budget', (w) => {
      ...
      left.append(el('div', { class: 'cb-p', style: { maxWidth: '92ch' } },
        bind((ww) => {
          ...
          return 'It is ' + bb.fy + ', day ' + bb.dayOfFY + '. The budget is ' + (bb.adopted ? 'adopted' : 'not adopted yet, and adoption is ' + daysText(bb.daysToAdoption) + ' away') + '. ' +

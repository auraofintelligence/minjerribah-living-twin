...
repository's rules are `docs/CONTRACT.md` and its companions, unchanged. You may not write into
`second-island` from here, and its agents may not write here. The first island keeps running as the
reference implementation, and being a good reference is part of this repository's job.
